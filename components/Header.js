          ...
          <div id="responsive-menu">
                    ...
                    <li>
                      <div id="search-container">
                        <input
                          ...
                          name="q"
                          className=""
                          placeholder="jo mange thakur apne te soi"
                          title="Enter 4 words minimum."
                          pattern="(\w+\W+){3,}\w+\W*"
                        />
                          ...
                          <div className="page" id="gurmukhi-keyboard-page-1">
                            <div className="keyboard-row">
                              <div className="keyboard-row-set">
                                <button data-value="a" type="button">
                                  a
                                </button>
                                <button data-value="A" type="button">
                                  A
                                </button>
                                <button data-value="e" type="button">
                                  e
                                </button>
                                <button data-value="s" type="button">
                                  s
                                </button>
                                <button data-value="h" type="button">
                                  h
                                </button>
                              </div>
                              <div className="keyboard-row-set">
                                <button data-value="k" type="button">
                                  k
                                </button>
                                <button data-value="K" type="button">
                                  K
                                </button>
                                <button data-value="g" type="button">
                                  g
                                </button>
                                <button data-value="G" type="button">
                                  G
                            ...
                            <div className="keyboard-row">
                              <div className="keyboard-row-set">
                                <button data-value="c" type="button">
                                  c
                                </button>
                                <button data-value="C" type="button">
                                  C
                                </button>
                                <button data-value="j" type="button">
                                  j
                                </button>
                                <button data-value="J" type="button">
                                  J
                              ...
                              <div className="keyboard-row-set">
                                <button data-value="t" type="button">
                                  t
                                </button>
                                <button data-value="T" type="button">
                                  T
                                </button>
                                <button data-value="f" type="button">
                                  f
                                </button>
                                <button data-value="F" type="button">
                                  F
                                </button>
                                <button data-value="x" type="button">
                                  x
                                </button>
                              </div>
                            </div>
                            <div className="keyboard-row">
                              <div className="keyboard-row-set">
                                <button data-value="q" type="button">
                                  q
                                </button>
                                <button data-value="Q" type="button">
                                  Q
                                </button>
                                <button data-value="d" type="button">
                                  d
                                </button>
                                <button data-value="D" type="button">
                                  D
                                </button>
                                <button data-value="n" type="button">
                                  n
                                </button>
                              </div>
                              <div className="keyboard-row-set">
                                <button data-value="p" type="button">
                                  p
                                </button>
                                <button data-value="P" type="button">
                                  P
                                </button>
                                <button data-value="b" type="button">
                                  b
                                </button>
                                <button data-value="B" type="button">
                                  B
                                </button>
                                <button data-value="m" type="button">
                                  m
                                </button>
                              </div>
                            </div>
                            <div className="keyboard-row">
                              <div className="keyboard-row-set">
                                ...
                                <button data-value="r" type="button">
                                  r
                                </button>
                                <button data-value="l" type="button">
                                  l
                                </button>
                                <button data-value="v" type="button">
                                  v
                                </button>
                                <button data-value="V" type="button">
                                  V
                              ...
                              <div className="keyboard-row-set">
                                ...
                                <a href="/help#Web-how-to-type-gurmukhi-with-keyboard">
                                  <button type="button">?</button>
                                </a>
                              </div>
                            </div>
            ...
            <div className="top-bar-right">
              ...
              <ul className="menu header-menu">
                ...
                <li className="close">
                  <span role="button" aria-label="Close menu">
                    Close
                  </span>
                </li>
              </ul>
