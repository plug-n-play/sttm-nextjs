...
const ShabadControllers = () => (
  <div id="shabad-controllers">
    <a className="display-options-toggle shabad-controller-toggle ">
    ...
    <a className="font-options-toggle shabad-controller-toggle ">
    ...
    <a className="shabad-controller-toggle ">
